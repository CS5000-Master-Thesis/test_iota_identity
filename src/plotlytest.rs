use log::info;
use plotly::{
    box_plot::BoxPoints, color::{Rgb, Rgba}, common::{Line, Marker}, layout::{Axis, Layout, Margin}, BoxPlot, ImageFormat, Plot
};
...
pub fn box_plot_styling_outliers() {
    ...
    // plot.show();
    info!("Saving to file");
    plot.write_image("D:/out.svg", ImageFormat::SVG, 800, 600, 1.0);
